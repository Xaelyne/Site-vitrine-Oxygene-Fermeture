...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nom = $_POST['nomFormulaireAvis'];
    $email = $_POST['emailFormulaireAvis'];
    $note = $_POST['noteFormulaireAvis'];
    $message = $_POST['commentaireFormulaireAvis'];
    ...
    try {
        ...
        $mail->Subject = "Vous avez un nouvel avis de ".$nom;
        $mail->Body = "<h2>Cet email provient du formulaire d'avis</h2<br><br> <h3>Informations du client :</h3><br> Nom: $nom <br> Note: $note"." étoiles"." <br> Commentaire: $message";
