...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nom = $_POST['nomFormulaireDevis'];
    $telephone = $_POST['telephoneFormulaireDevis'];
    $email = $_POST['emailFormulaireDevis'];
    $choix = $_POST['choixFormulaireDevis'];
    $sujet = $_POST['sujetFormulaireDevis'];
    $message = $_POST['messageFormulaireDevis'];
