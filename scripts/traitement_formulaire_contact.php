...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Subject = $sujet;
        $mail->Body = "<h2>Cet email provient du formulaire de contact</h2<br><br> <h3>Information du client :</h3><br> Nom: $nom <br> Téléphone: $telephone <br> Email: $email <br><br> Sujet: $sujet <br> Message: $message";
